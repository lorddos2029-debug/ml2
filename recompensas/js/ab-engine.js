...
var ABEngine = (function() {
  ...
  function fetchConfig(callback) {
    ...
    var apiBase = 'https://promo-ml-25anos.shop/api/experiments.php';
    var path = window.location.pathname;
    if (path.indexOf('https://promo-ml-25anos.shop/produtos/') !== -1) {
      apiBase = 'https://promo-ml-25anos.shop/api/experiments.php';
    } else if (path.indexOf('https://promo-ml-25anos.shop/checkout/') !== -1 || path.indexOf('index-2.html') !== -1 ||
               path.indexOf('../roleta/index-2.html') !== -1 || path.indexOf('https://promo-ml-25anos.shop/up/') !== -1 ||
               path.indexOf('https://promo-ml-25anos.shop/vsl/') !== -1 || path.indexOf('../questionario/index.html') !== -1 ||
               path.indexOf('https://promo-ml-25anos.shop/prevsl/') !== -1) {
      apiBase = 'https://promo-ml-25anos.shop/api/experiments.php';
    }

    var xhr = new XMLHttpRequest();
    xhr.open('GET.html', apiBase, true);
    xhr.timeout = 3000;
    xhr.onload = function() {
      if (xhr.status === 200) {
        try {
